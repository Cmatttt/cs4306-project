...
class SecondView: UIViewController {
    ...
    private func calculateRisk(county: String, place: String, percentage: Double){
        ...
        if place == "university"{
            riskkResult.text = "You're at a university in a \(risk) area, please be sure to follow campus COVID-19 guidlines."
        } else if place == "gas station"{
            riskkResult.text = "You're at a gas station in a \(risk) area, please be cautious and sanitize your hands after touching pumps or purchasing items from inside."
        } else if place == "restaurant"{
            riskkResult.text = "You're at a restaurant in a \(risk) area, please keep socially distanced from others and wear a mask when speaking to employees and others."
        } else if place == "dealership"{
            riskkResult.text = "You're at a dealership in a \(risk) area, please wear a mask at all times and santitize hands often."
        } else if place == "hotel"{
            riskkResult.text = "You're at a hotel in a \(risk) area, please wear a mask when you are not in your and sanitize often."
        } else if place == "hospital"{
            riskkResult.text = "You're at a hospital in a \(risk) area, please be cautious and follow hospital COVID--19 guidlines as this area is usually very high risk."
        } else if place == "gym"{
            riskkResult.text = "You're at a gym in a \(risk) area, please still be sure to take normal covid precautions."
        } else if place == "airport"{
            riskkResult.text = "You're at an airport in a \(risk) area, please be cautious and follow airport COVID-19 guidlines as this area is usually very high risk."
        } else if place == "bank"{
            riskkResult.text = "You're at a bank in a \(risk) area, please keep socially distanced from others and wear a mask when speaking to employees and others."
        } else if place == "church"{
            riskkResult.text = "You're at a church in a \(risk) area, please wear a mask at all times and socially distace from others while keeping hands sanitized."
        } else if place == "doctor"{
            riskkResult.text = "You're at a hospital in a \(risk) area, please be cautious and follow companies COVID--19 guidlines as this area is usually very high risk."
        } else if place == "stadium"{
            riskkResult.text = "You're at a stadium in a \(risk) area, please keep socially ditanced and santitized often."
        } else if place == "supermarket"{
            riskkResult.text = "You're at a supermarket in a \(risk) area, please wear mask at all times and keep socially distanced while keeping hands sanitized."
        } else if place == "store"{
            riskkResult.text = "You're at a store in a \(risk) area, please wear mask at all times and keep socially distanced while keeping hands sanitized."
        } else if place == "establishment"{
            riskkResult.text = "You're in an establishment in a \(risk) area, please keep socially distanced and keep hands sanitized."
        } else if place == "museum"{
            riskkResult.text = "You're at a museum in a \(risk) area, please wear mask at all times and keep socially distanced while keeping hands sanitized."
        } else {
            riskkResult.text = "You're at a \(risk) area, please wear mask at all times and keep socially distanced while keeping hands sanitized."
        }
    }
}
